    ...
    public function categoryproducts(Request $request, $id)
{
    ...
    public function storemessage(Request $request)
    {
        ...
        $data->ip = request()->ip();
        $data->save();
        return redirect()->route('contact')->with('success', 'Pesanan Anda Telah Terikirim, Terima Kasih');
    }
    public function storecomment(Request $request)
    {
        ...
        $data->status = 'Baru';
        $data->save();
        return redirect()->route('product', ['id' => $request->input('product_id')])->with('success', 'Komentar Anda Telah Terkirim, Terima Kasih');
    }
    ...
    public function storefavorite($id)
    {
        ...
        $data->user_id = Auth::id();
        $data->save();
        return redirect()->back()->with('info', 'Produk Ditambahkan ke Favorit');
    }
    public function destroyfavorite($id)
    {
        $data=FavoriteProduct::find($id);;
        $data->delete();
        return redirect()->back()->with('info', 'Produk Dihapus dari Favorit');
    }
